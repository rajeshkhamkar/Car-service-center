    ...
    <main class="container clear"> 
      <!-- main body --> 
	    <div style="width: 70%; float:left; margin-right:30px" id="login-home">
		  <h2>Welcome to Car Service Center</h2>
		 ...
		 <% if(session.getAttribute("login_level") != null && session.getAttribute("login_level").equals("1")) { %>		
		  <ul>
		  	<li><a href="product.jsp?product_id=0">Car Package Management</a></li>
			<li><a href="report-product.jsp?type_id=0">All Package Report</a></li>
